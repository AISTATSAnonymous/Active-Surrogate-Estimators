...
from activetesting.utils.utils import add_val_idxs_to_cfg
from activetesting.utils.data import to_json
...
# kernprof -l main.py +quadrature_temp_scaled_retrain=SmallMNISTBNNMissingNew +experiments=scratch experiment.n_runs=1
